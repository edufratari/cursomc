...
import com.eduardofratari.cursomc.dto.ClienteDTO;
...
import com.eduardofratari.cursomc.services.exceptions.DataIntegrityException;
...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null, objDto.getNome(), objDto.getEmail(), objDto.getCpfOuCnpj(), TipoCliente.toEnum(objDto.getTipoCliente()), passwordEncoder.encode(objDto.getSenha()));
